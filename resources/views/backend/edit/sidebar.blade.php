<div id="sidebar-wrapper" style="min-height:100vh; width:350px;">
    ...
    <div class="accordion" id="sidebarAccordion">
        ...
        <div class="accordion-item mb-3">
            ...
            <div id="collapseNavbar" class="accordion-collapse collapse" aria-labelledby="headingNavbar"
                ...
                <div class="accordion-body">
                    <form action="{{ route('update.header', $product->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="accordion-item mb-3">
            ...
            <div id="collapseHero" class="accordion-collapse collapse" aria-labelledby="headingHero"
                data-bs-parent="#sidebarAccordion">
                <div class="accordion-body">
                    <form action="{{ route('update.hero', $product->id) }}" method="POST"
        ...
        <div class="accordion-item mb-3">
            ...
            <div id="collapseFeature" class="accordion-collapse collapse" aria-labelledby="headingFeature"
                ...
                <div class="accordion-body">
                    <!-- Update Form -->
                    <form action="{{ route('update.feature', $product->id) }}" method="POST">
                        @csrf
                        <div class="mb-3">
                        ...
                        <ul class="list-group">
                            @foreach ($feature->data['features'] as $index => $featureItem)
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <form action="{{ route('feature.destroy', [$index, $product->id]) }}"
        ...
        <div class="accordion-item mb-3">
            ...
            <div id="collapseOverview" class="accordion-collapse collapse" aria-labelledby="headingOverview"
                data-bs-parent="#sidebarAccordion">
                <div class="accordion-body">
                    <form action="{{ route('update.overview', $product->id) }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
